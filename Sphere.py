...
class Sphere:
    ...
    def get_collision(self, v: Vector):
        ...
        # print("direction magnitude squared:",a, "center mag :",self.center.magnitude())
        c = self.center.magnitude() ** 2 - self.r ** 2
        # print("c : ",c)
        # print("v direction ", v.get_direction(),v.get_direction().magnitude())
        # print(v.get_direction().multiply(self.center.scale(-1)))
